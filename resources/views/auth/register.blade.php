                        ...
                        <div class="p-3">
                            ...
                            <form class="form-horizontal mt-3" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input required name="name" value="{{ old('name') }}" class="form-control" type="text" required="" placeholder="Name">
                                    </div>
                                </div>

                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input required name="username" value="{{ old('username') }}" class="form-control" type="text" required="" placeholder="Username">
                                    </div>
                                </div>
    
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input required name="email" value="{{ old('email') }}" class="form-control" type="email" required="" placeholder="Email">
                                    </div>
                                </div>
    
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input required name="password" class="form-control" type="password" required="" placeholder="Password">
                                    </div>
                                </div>

                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input required name="password_confirmation" class="form-control" type="password" required="" placeholder="Password Confirmation">
                                    </div>
                                </div>
